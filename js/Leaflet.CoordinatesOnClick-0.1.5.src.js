...
L.Control.Coordinates = L.Control.extend({
	...
	expand: function() {
		...
		this._map.off("click", this._update, this);
	...
	collapse: function() {
		if (!this._showsCoordinates) {
			this._map.on("click", this._update, this);
			this._showsCoordinates = true;
			var opts = this.options;
			L.DomEvent.addListener(this._container, "click", this._switchUI, this);
			L.DomEvent.removeListener(this._container, "click", L.DomEvent.stop);
	...
	onRemove: function(map) {
		map.off("click", this._update, this);
	},

	/**
	 *	click callback function updating labels and input elements
	 */
